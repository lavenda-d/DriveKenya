...
// Get all maintenance records for owner
router.get('/maintenance', authenticateToken, requireHost, async (req, res, next) => {
  try {
    const hostId = req.user.id;
    console.log('Owner dashboard: fetching all maintenance for hostId=', hostId);
